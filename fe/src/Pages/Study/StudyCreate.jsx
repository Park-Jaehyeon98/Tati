...
const StudyCreate = () => {
    ...
    //     return <button className={categoryName === category ? style.selected : style.noSelceted} onClick={() => handleCategoryClick(category)}>{category}</button>
    // });
            ...
            <div style={{ margin: "auto", width: 1000, display: "flex", textAlign: "center", justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
                ...
                <div>
                    ...
                    {categoryArray.map((categoryItem, index) =>
                        <button key={categoryItem} className={index === category ? style.selected : style.noSelected} onClick={() => handleCategoryClick(index)}>{categoryItem}</button>
                    )}
                </div>
