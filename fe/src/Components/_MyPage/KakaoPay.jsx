...
export default function KakaoPay() {
  ...
  return (
    <div className={style.KakaoPay_box}>
      <div className={style.btn_box}>
        <p className={style.KakaoPay_title}>카카오페이 결제</p>
        {/* <button key="payButton" className={style.success_btn} onClick={handleSuccess}>결제하기</button> */}
        <button key="cancelButton" className={style.cancel_btn} onClick={handleCancel}>취소</button>
      </div>
    </div>
  );
}
